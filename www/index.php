<?php require_once __DIR__ . '/../../waterview-vip-portal/vendor/engaged-nation/portal-core/FrontEnd/Bootstrap/client-front-end.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>VIP Preferred Rewards</title>
    <?php require_once __DIR__ . '/../../waterview-vip-portal/vendor/engaged-nation/portal-core/GoogleTagManager/Resources/public/gtm.php'; ?>
    ...
    <script async defer src="https://tools.luckyorange.com/core/lo.js?site-id=654fc604"></script>
</head>
<body>
    ...
    <script src="//<?php echo $enConfigClient['environment']['site_portal']; ?>/lib/js/engage.php?client_name=waterview-vip&client_id=e0c6b0e16076a8ea65b864e30ee786e9" type="text/javascript"></script>
